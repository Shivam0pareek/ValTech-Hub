...
import TableOfContents from "./_component/TableOfContent";

export const metadata = {
  title: "Terms of Service | freecourse.live",
  description: "Read the Terms of Service for using freecourse.live.",
};
  ...
  return (
    <main className="max-w-4xl mx-auto p-6 text-gray-800">
      ...
      <TableOfContents />
        <section
          id="agreement"
          className="bg-card border rounded-lg p-6 md:p-8 animate-in fade-in duration-500"
        >
          <h2 className="text-2xl font-bold mb-4">
            AGREEMENT TO OUR LEGAL TERMS
          </h2>
          <p>
            We are FreeCourse.live ("Company," "we," "us," "our"), a company
            registered in India.
          </p>
          <p>
            We operate the website freecourse.live (the "Site"), as well as any
            other related products and services that refer or link to these
            legal terms (the "Legal Terms") (collectively, the "Services").
          </p>
          <p>
            Transform your knowledge into professional courses with AI. Generate
            comprehensive course materials and find relevant YouTube content
            automatically.
          </p>
          <p>
            You can contact us by email at mail@FreeCourse.live.
          </p>
          <p>
            These Legal Terms constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity ("you"),
            and FreeCourse.live, concerning your access to and use of the Services.
          ...
          <p>
            ...
            effective upon posting or notifying you by mail@freecourse.live, as
        ...
        >
          ...
          <p>
            ...
            please address your request to:mail@FreeCourse.live. If we ever grant you the
          ...
          <h3 className="text-xl font-semibold mt-6 mb-2">Your submissions</h3>
          <p>
        ...
        >
          ...
          <h3 className="text-xl font-semibold mt-6 mb-2">Free Trial</h3>
          <p>
            We offer a 5-day free trial to new users who register with the
          ...
          <h3 className="text-xl font-semibold mt-6 mb-2">Cancellation</h3>
          <p>
            ...
            mail@FreeCourse.live.
          </p>
          <h3 className="text-xl font-semibold mt-6 mb-2">Fee Changes</h3>
          <p>
        ...
        >
          ...
          <p>
          We care about data privacy and security. Please review our Privacy Policy: <a className="text-primary font-bold" href="https://freecourse.live/privacy-policy">https://freecourse.live/privacy-policy</a>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in India. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in India, then through your continued use of the Services, you are transferring your data to India, and you expressly consent to have your data transferred to and processed in India.
          </p>
        ...
        >
          ...
          <p>
          These Legal Terms shall be governed by and defined following the laws of India. FreeCourse.live and yourself irrevocably consent that the courts of India shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.</p>
        ...
        >
          ...
          <p>
          You agree to irrevocably submit all disputes related to these Legal Terms or the legal relationship established by these Legal Terms to the jurisdiction of the India courts. FreeCourse.live shall also maintain the right to bring proceedings as to the substance of the matter in the courts of the country where you reside or, if these Legal Terms are entered into in the course of your trade or profession, the state of your principal place of business.</p>
        ...
        >
          ...
          <p>
         In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at: <a href="mailto:mail@freecourse.live">mail@freecourse.live</a>
</p>
